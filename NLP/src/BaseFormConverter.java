...
public class BaseFormConverter {
	...
	public static void main(String[] args) {
		...
		if((input=System.getProperty("input"))==null) {
			throw new RuntimeException("Use -Dinput=<input> option to specify the input file/directory.");
		}
		if((output=System.getProperty("output"))==null) {
			throw new RuntimeException("Use -Doutput=<input> option to specify the output file/directory.");
		}
